...
export default function FAQPage() {
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "We serve all of Florida, with our main office in Orlando. We're licensed public adjusters throughout the state and can handle claims anywhere in Florida.",
    },
  ]
