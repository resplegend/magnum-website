    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <h3 className="text-2xl font-semibold text-primary">ORLANDO PUBLIC ADJUSTERS</h3>
          ...
          <p className="text-lg leading-relaxed text-muted-foreground">
            ...
            knowledge of commercial and business policies. River City Claims Public Adjusters will ensure your position
            in the claim is protected, the best possible outcome is achieved, income interruption, and how to protect
            your investment in the future. We have experience in significant condominium losses, retail stores, office
            space, and warehouse losses.
          </p>
        </div>
      </div>
    </section>
